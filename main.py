...
try:
 ...
 def UravxBuCwNMpYWTzKhPt():
  ...
  UravxBuCwNMpYWTzKhPI("Nuyulin BitcoinClickBot ".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("WhatsApp : +6282210396xxx")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("Created : INDONESIA CRYPTO TEAM | Edit by : Maenotak")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPq+"Maenotak is Newbie & Script Kiddie".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
 async def UravxBuCwNMpYWTzKhPF():
  ...
  if UravxBuCwNMpYWTzKhPg(UravxBuCwNMpYWTzKhPs)<2:
   ...
   UravxBuCwNMpYWTzKhRA(1)
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPn+"Jangan Lupa Kopinya Sebelum Lanjut",end="\n\n")
  ...
  if me.username=='bagas_q' or me.id==415792043 or me.id==611711558:
   UravxBuCwNMpYWTzKhcO(me.id if me.username is UravxBuCwNMpYWTzKhPH else me.username+' Udah Masuk Nih Boss!!')
   try:
    ...
    pass
   try:
    if me.username is not UravxBuCwNMpYWTzKhPH and me.username=='Maenotak':
    ...
    pass
  UravxBuCwNMpYWTzKhcg(UravxBuCwNMpYWTzKhPq+'[+]Seruput Dulu Kopinya!!! :)')
   ...
   if UravxBuCwNMpYWTzKhRt(UravxBuCwNMpYWTzKhcb)is not UpdateShortMessage:
    if UravxBuCwNMpYWTzKhRk(UravxBuCwNMpYWTzKhcb.message,'reply_markup')and UravxBuCwNMpYWTzKhRt(UravxBuCwNMpYWTzKhcb.message.reply_markup)is ReplyInlineMarkup:
     ...
     if UravxBuCwNMpYWTzKhco is not UravxBuCwNMpYWTzKhPH:
      UravxBuCwNMpYWTzKhcg(UravxBuCwNMpYWTzKhPq+'[+] Slow But Sure Nih:)')
      ...
      while UravxBuCwNMpYWTzKhPE:
       ...
       if UravxBuCwNMpYWTzKhcd==302:
        UravxBuCwNMpYWTzKhPf.write(UravxBuCwNMpYWTzKhPn+'[%s] STATUS: %s (%d)\r'%(UravxBuCwNMpYWTzKhPQ().strftime("%H:%M:%S"),'Ada Yang Salah' if cc is not UravxBuCwNMpYWTzKhPH else 'Good Job',UravxBuCwNMpYWTzKhcD))
        break
  ...
  async def UravxBuCwNMpYWTzKhPL(event):
   UravxBuCwNMpYWTzKhcg(UravxBuCwNMpYWTzKhPd+"Iklan Nggak Tersedia"+UravxBuCwNMpYWTzKhPG)
   UravxBuCwNMpYWTzKhcg("Disconnecting")
   await UravxBuCwNMpYWTzKhcl.disconnect()
  UravxBuCwNMpYWTzKhcl.add_event_handler(UravxBuCwNMpYWTzKhPL,UravxBuCwNMpYWTzKhPX(incoming=UravxBuCwNMpYWTzKhPE,chats="BitcoinClick_bot",pattern='Sorry, Buat Sementara Kayanya Blom Ada Iklan Bisa Di Anu Nih.'))
  ...
  UravxBuCwNMpYWTzKhcl.add_event_handler(UravxBuCwNMpYWTzKhPe,UravxBuCwNMpYWTzKhPX(incoming=UravxBuCwNMpYWTzKhPE,chats="BitcoinClick_bot",pattern='Lumayan Nih Lu Dapet'))
